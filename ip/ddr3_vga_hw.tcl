...
# Sat Mar 11 11:43:12 CST 2023
# DO NOT MODIFY


# 
# ddr3_vga "ddr3_vga" v1.0
#  2023.03.11.11:43:12
# 
# 
...
set_module_property NAME ddr3_vga
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME ddr3_vga
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL ddr3_vga_top
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file ddr3_vga.qxp QXP PATH ddr3_vga.qxp
...
add_interface_port cfg_bus avalon_write write Input 1
add_interface_port cfg_bus avalon_read read Input 1
add_interface_port cfg_bus avalon_addr address Input 4
add_interface_port cfg_bus avalon_read_data readdata Output 32
add_interface_port cfg_bus avalon_write_data writedata Input 32
...
add_interface_port data_bus avl_waitrequest waitrequest Input 1
add_interface_port data_bus avl_addr address Output 32
add_interface_port data_bus avl_rdata_valid readdatavalid Input 1
add_interface_port data_bus avl_rdata readdata Input 128
add_interface_port data_bus avl_wdata writedata Output 128
add_interface_port data_bus avl_be byteenable Output 16
add_interface_port data_bus avl_read_req read Output 1
add_interface_port data_bus avl_write_req write Output 1
add_interface_port data_bus avl_size burstcount Output 10


# 
# connection point vga_bus
# 
add_interface vga_bus conduit end
set_interface_property vga_bus associatedClock clock
set_interface_property vga_bus associatedReset reset
set_interface_property vga_bus ENABLED true
set_interface_property vga_bus EXPORT_OF ""
set_interface_property vga_bus PORT_NAME_MAP ""
set_interface_property vga_bus CMSIS_SVD_VARIABLES ""
set_interface_property vga_bus SVD_ADDRESS_GROUP ""

add_interface_port vga_bus vga_clk vga_clk Output 1
add_interface_port vga_bus vga_de vga_de Output 1
add_interface_port vga_bus vga_hsync vga_hsync Output 1
add_interface_port vga_bus vga_rgb vga_rgb Output 24
add_interface_port vga_bus vga_vsync vga_vsync Output 1
